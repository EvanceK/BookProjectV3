...
public class ShoppingCarUI3 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ShoppingCarUI3 frame = new ShoppingCarUI3(conn, m, bookOrders, bookOrdersDetails);
	...
	public ShoppingCarUI3(Connection conn,Member m, BookOrders bookOrders, List<BookOrdersDetail> bookOrdersDetails) {
