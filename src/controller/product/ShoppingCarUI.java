...
public class ShoppingCarUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ShoppingCarUI frame = new ShoppingCarUI(conn,shoppingCar, m);
	...
	public ShoppingCarUI(Connection conn ,List<Products> shoppingCar, Member m) {
		this.conn=conn;
		...
		JRadioButton rdbtnNewRadioButton_1 = new JRadioButton("貨到付款");
			...
			public void mouseClicked(MouseEvent e) {
				if (rdbtnNewRadioButton.isSelected()) {
		          ...
		          int totalAmount = Integer.valueOf(finalamount.getText()); // 計算總金額
		            ...
		            if (finalAmount > m.getBalance()) {
		                // 如果扣除點數後的金額大於餘額，彈出提示
		                javax.swing.JOptionPane.showMessageDialog(null, "餘額不足，請儲值或選擇貨到付款！");
		                
		            } else {
		            	bookOrders = new BookOrders();
		            	bookOrders.setUserId(m.getUserId()); 	// 將會員綁定到訂單
						...
						ShoppingCarUI2 shoppingCarUI2 = new ShoppingCarUI2(conn,shoppingCar, m,finalAmount,pointsUsed,bookOrders,bookOrdersDetails);
						shoppingCarUI2.setVisible(true);
						dispose();
		            }
		         //else貨到付款   
				}else {
			            ...
			            int finalAmount = totalAmount - pointsUsed; // 扣除點數後的金額
			            ShoppingCarUI2_2 ShoppingCarUI2_2 = new ShoppingCarUI2_2(conn,shoppingCar, m,finalAmount,pointsUsed,bookOrders,bookOrdersDetails);
					ShoppingCarUI2_2.setVisible(true);
					dispose();
				}
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
                ...
                Object[] message = {
                    "我是用來模擬線上儲值，請輸入正整數金額:", inputField
                };
		...
		point.getDocument().addDocumentListener(new DocumentListener() {
		    ...
		    private void updateFinalAmount() {
		        try {
		            ...
		            int discountedTotal = DiscountService.calculateDiscountedTotal(Integer.valueOf(totalamount.getText()), point.getText());
