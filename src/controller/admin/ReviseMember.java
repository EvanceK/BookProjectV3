...
public class ReviseMember extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ReviseMember frame = new ReviseMember(member,memberInfo);
	 ...
	 * Create the frame.
	 */
	public ReviseMember(Member member,MemberInfo memberInfo) {
		...
		lblNewLabel_10.setBounds(37, 324, 46, 15);
		panel.add(lblNewLabel_10);
		
		JLabel lblNewLabel_11 = new JLabel("電話");
		lblNewLabel_11.setBounds(37, 376, 46, 15);
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				conn = DbConnection.getDbConnection();
				  ...
				  msi.updateMemberAll(conn, member); 		//更新member

				  misi.updateMemberInfo(conn, memberInfo);  //更新memberInfo
